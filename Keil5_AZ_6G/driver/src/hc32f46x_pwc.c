...
/**
 *******************************************************************************
 ** \brief  Switch high speed mode to 200MHz .
 **
 ** \param  None
 **
 ** \retval None
 ...
 **
 ******************************************************************************/
void PWC_HighSpeedto200MHz(void)
{
    ENABLE_PWR_REG_WRITE();
    M4_SYSREG->PWR_PWRC2_f.DDAS = 0xf;
    M4_SYSREG->PWR_PWRC2_f.DVS = 0;
    M4_SYSREG->PWR_MDSWCR = 0x10;
    DISABLE_PWR_REG_WRITE();
    Ddl_Delay1ms(1);
}
